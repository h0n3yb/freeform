-- CreateEnum
CREATE TYPE "PieceStatus" AS ENUM ('GREENWARE', 'BISQUED', 'GLAZED', 'COMPLETED');
...
-- AddForeignKey
ALTER TABLE "Image" ADD CONSTRAINT "Image_pieceId_fkey" FOREIGN KEY ("pieceId") REFERENCES "Piece"("id") ON DELETE CASCADE ON UPDATE CASCADE;
